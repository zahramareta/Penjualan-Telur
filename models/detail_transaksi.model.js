 ...
 */
 ...
 exports.findAll = () => {
     return new Promise((resolve, rejected) => {
         ...
         let query = `select * from ${tableName} join telur on telur.id = transaksi.id_telur
         join pack on pack.id_pack = transaksi.id_pack `
 ...
 exports.findByCriteria = (parameter) => {
     return new Promise((resolve, rejected) => {
         ...
         /** define query to get all data */
         let query = `select * from ${tableName} join telur on telur.id = detail_transaksi.id_telur 
         join pack on pack.id_pack = detail_transaksi.id_pack where ${params}`
